...
public class Valuta_USD extends Valuta
{
    BeszerzesiStrategia beszerzes;
    ArfolyamStrategia arfolyam;
    KoltsegStrategia koltseg;

    public Valuta_USD(BeszerzesiStrategia beszerzes, ArfolyamStrategia arfolyam,KoltsegStrategia koltseg, String nev,String tipus)
    {
        super(nev,tipus);
